...
curl -sfL https://get.k3s.io | INSTALL_K3S_EXEC="server --node-ip 192.168.56.110 --bind-address 192.168.56.110 --tls-san=192.168.1.50 --flannel-iface=eth1" sh -
